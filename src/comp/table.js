...
function Home() {
  ...
  const handleData = async (e) => {
    ...
    try {
      ...
      const reponse = await axios.post(
        "https://6222-2409-40f4-1d-aa8a-c1ba-4627-762b-c1c0.ngrok-free.app/idcard",
        formData,
        {
          headers: {
  ...
  const downloadImagesZip = () => {
    axios({
      url: "https://6222-2409-40f4-1d-aa8a-c1ba-4627-762b-c1c0.ngrok-free.app/download", // Change URL if Flask app is running on different port or domain
      method: "GET",
      responseType: "blob",
    }).then((response) => {
