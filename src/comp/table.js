...
//           <div className="row">
//             <div className="col bg-success  " style={{height:"100vh"}}>
//                 <div className="d-flex justify-content-center align-items-center">centered</div>
//             </div>
//             <div className="col bg-light " style={{height:"100vh"}}>123</div>
//           </div>
//           <div className="row">
//             <div className="col bg-success " style={{height:"100vh"}}>123</div>
...
//     <div className="col-lg-6 bg-success  text-white" style={{ height: "100vh" }}>
//       centered
//     </div>
//     <div className="col-lg-6 bg-light" style={{ height: "100vh" }}>
//       123
//     </div>
//   </div>
...
function Home() {
  ...
  const handleData = async (e) => {
    ...
    try {
      ...
      const reponse = await axios.post(
        "https://e39d-2409-40f4-1d-aa8a-c1ba-4627-762b-c1c0.ngrok-free.app/idcard",
        formData,
        {
          headers: {
  ...
  const downloadImagesZip = () => {
    axios({
      url: "https://e39d-2409-40f4-1d-aa8a-c1ba-4627-762b-c1c0.ngrok-free.app/download", // Change URL if Flask app is running on different port or domain
      method: "GET",
      responseType: "blob",
    }).then((response) => {
  ...
  return (
    <>
      <div className="container">
        <h1 className="head text-center text-white">
          <img src={Icon} className="me-3 " style={{ width: "6%" }} />
          Id Card Maker
        </h1>
        ...
        <div className="row">
                ...
                <div className="row">
                  <div className="col-sm-12 col-lg-12">
                    <div className="mb-3">
                      ...
                      />
                      {errors.idno && (
                        <span className="error">{errors.idno}</span>
                      )}
                    </div>
                  </div>
                </div>
          ...
          <div
            className="col-sm-12 col-lg-6 mt-sm-3  mt-lg-0"
            style={{ marginBottom: "auto", height: "100vh" }}
          >
